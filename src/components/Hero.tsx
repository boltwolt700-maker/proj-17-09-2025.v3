...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-16 pb-20 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-white/30 via-white/10 to-white/20 z-10"></div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-40">
        <div className="animate-fade-in-up">
          {/* Trust Badge */}
          <div className="inline-flex items-center gap-2 bg-white/95 backdrop-blur-md px-4 py-2 rounded-full border border-indigo-200/50 shadow-lg mb-8">
          ...
          <h1 className="text-5xl md:text-7xl font-bold text-slate-800 mb-6 leading-tight drop-shadow-lg">
          ...
          <p className="text-xl md:text-2xl text-slate-700 mb-8 max-w-4xl mx-auto leading-relaxed drop-shadow-md">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-8">
            <div className="flex items-center gap-2 bg-green-50/95 backdrop-blur-md px-4 py-2 rounded-full border border-green-200 shadow-lg">
              <CheckCircle className="w-5 h-5 text-green-600" />
              <span className="text-green-700 font-medium">87% get more interviews</span>
            </div>
            <div className="flex items-center gap-2 bg-blue-50/95 backdrop-blur-md px-4 py-2 rounded-full border border-blue-200 shadow-lg">
              <Zap className="w-5 h-5 text-blue-600" />
              <span className="text-blue-700 font-medium">3x LinkedIn engagement</span>
            </div>
            <div className="flex items-center gap-2 bg-purple-50/95 backdrop-blur-md px-4 py-2 rounded-full border border-purple-200 shadow-lg">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-12">
            <button 
              ...
              className="bg-gradient-to-r from-indigo-500 to-purple-600 text-white px-8 py-4 rounded-xl font-semibold text-lg hover:shadow-2xl hover:shadow-indigo-500/25 transition-all duration-300 transform hover:scale-105 flex items-center gap-2 shadow-xl backdrop-blur-md"
            >
            ...
            <button className="flex items-center gap-2 text-slate-600 hover:text-slate-800 transition-colors group">
              <div className="w-12 h-12 bg-white/95 backdrop-blur-md rounded-full flex items-center justify-center group-hover:bg-white transition-colors shadow-lg">
          ...
          <div className="animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
            ...
            <div className="flex items-center justify-center gap-8 opacity-70">
              <div className="bg-white/95 backdrop-blur-md px-6 py-3 rounded-lg shadow-lg border border-slate-200 font-bold text-slate-700">Google</div>
              <div className="bg-white/95 backdrop-blur-md px-6 py-3 rounded-lg shadow-lg border border-slate-200 font-bold text-slate-700">Microsoft</div>
              <div className="bg-white/95 backdrop-blur-md px-6 py-3 rounded-lg shadow-lg border border-slate-200 font-bold text-slate-700">Amazon</div>
              <div className="bg-white/95 backdrop-blur-md px-6 py-3 rounded-lg shadow-lg border border-slate-200 font-bold text-slate-700">Meta</div>
              <div className="bg-white/95 backdrop-blur-md px-6 py-3 rounded-lg shadow-lg border border-slate-200 font-bold text-slate-700">Tesla</div>
            </div>
          </div>
        </div>
      </div>
